...
VALUES
  ('SB1','RT-5 Flea Solid Fuel Booster','163 kN','192 kN','1372,9 m/s','1618,1 m/s','1,5 t (Start)','2000 K','While considered by some to be little more than "a trash bin full of boom", The RT-5 can be seen in use at many space programs, perhaps possibly because it is the only option for many space programs, but nevertheless, this small booster provides a nice kick to lift small payloads to considerable heights. Use with caution, though. Once lit, solid fuel motors cannot be put out until the fuel runs out.','200','Img_SB_1_tn.png','Img_SB_1_ex1.png','Img_SB_1_ex2.png'),
  ('SB2','BACC Thumper Solid Fuel Booster','250 kN','300 kN','1716,2 m/s','2059,4 m/s','7,65 t (Start)','2200 K','Filled with a new, even more volatile fuel, the BACC offers semi-reliable performance at a good price.','850','Img_SB_2_tn.png','Img_SB_2_ex1.png','Img_SB_2_ex2.png'),
  ('SB3','S2-33 Clydesdale Solid Fuel Booster','2950 kN','3300 kN','2057,3 m/s','2304,6 m/s','1440 t (Start)','2200 K','The Clydesdale is not surprising just for its size. It is also amazing just how much thrust comes out of this motor - nothing else in its size class comes close.','18500','Img_SB_3_tn.png','Img_SB_3_ex1.png','Img_SB_3_ex2.png'),
